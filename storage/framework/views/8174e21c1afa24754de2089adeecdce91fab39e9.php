...
<body class="sb-nav-fixed">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($record->name); ?></td>
                                        <td><?php echo e($record->email); ?></td>
                                        <td><?php echo e($record->clock_in_time ?? '-'); ?></td>
                                        ...
                                        <td><?php echo e($record->status); ?></td> <!-- 显示状态 -->
                                    </tr>
    ...
    <script>
        ...
        fetch("<?php echo e(route('admin.getNotificationCount')); ?>")
            .then(response => {
...
</html><?php /**PATH C:\xampp\htdocs\FYP-2\SnapChat\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>