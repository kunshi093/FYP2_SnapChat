...
<body class="sb-nav-fixed">
        ...
        <ul class="navbar-nav ms-auto me-3">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="<?php echo e(route('staff.profile')); ?>">Profile</a></li>
                    <li>
            ...
            <main class="container-fluid">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4 d-flex flex-column gap-3">
                        ...
                        <audio id="clockInSound" src="<?php echo e(asset('sounds/clock-in.mp3')); ?>"></audio>
                        <!-- Clock Out -->
                    ...
                    <audio id="clockOutSound" src="<?php echo e(asset('sounds/clock-out.mp3')); ?>"></audio>
                                ...
                                <div class="card-body d-flex flex-column"> <!-- 添加 flex-column -->
                                    ...
                                    <?php if($currentLeave): ?>
                                        <p>
                                            ...
                                            <?php if($currentLeave->status === 'pending'): ?>
                                                <span class="badge bg-warning">Pending</span>
                                            <?php elseif($currentLeave->status === 'approved'): ?>
                                                <span class="badge bg-success">Approved</span>
                                            <?php else: ?>
                                                <span class="badge bg-danger">Rejected</span>
                                            <?php endif; ?>
                                        </p>
                                        <p><strong>From:</strong> <?php echo e($currentLeave->start_date); ?></p>
                                        <p><strong>To:</strong> <?php echo e($currentLeave->end_date); ?></p>
                                    <?php else: ?>
                                        <p>No current leave applications.</p>
                                    <?php endif; ?>
                                    <p><strong>Total Leave Days:</strong> <?php echo e($totalLeaveDays); ?> days</p> <!-- 显示总请假天数 -->
                                    <div class="mt-auto"> <!-- 将 View Leave History 放到底部 -->
                                        <a href="<?php echo e(route('staff.leaveHistory')); ?>" class="text-white">View Leave History</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ms-100">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Present</td>
                                        <td><?php echo e($attendanceDays); ?> days</td>
                                    </tr>
                                    <tr>
                                        <td>Absent</td>
                                        <td><?php echo e($absenceDays); ?> days</td>
                                    </tr>
                    ...
                    <div class="card-body">
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($record->clock_in_time ? $record->clock_in_time->format('Y-m-d') : '-'); ?></td>
                                    <td><?php echo e($record->clock_in_time ? $record->clock_in_time->format('h:i A') : '-'); ?></td>
                                    <td><?php echo e($record->clock_out_time ? $record->clock_out_time->format('h:i A') : '-'); ?></td>
                                    <td>
                                        <?php if($record->photo): ?>
                                            <a href="<?php echo e(asset('storage/' . $record->photo)); ?>" target="_blank" class="btn btn-success btn-sm">
                                                View Photo
                                            </a>
                                        <?php else: ?>
                                            <form action="<?php echo e(route('staff.uploadPhoto', $record->id)); ?>" method="POST" enctype="multipart/form-data" class="d-flex align-items-center justify-content-center">
                                                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        const attendanceData = {
            present: <?php echo e($attendanceDays); ?>,
            absent: <?php echo e($absenceDays); ?>,
        ...
        document.getElementById('clockInBtn').addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("staff.clockIn")); ?>', {
                method: 'POST',
                headers: {
        ...
        document.getElementById('clockOutBtn').addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("staff.clockOut")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Content-Type': 'application/json'
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const absenceDays = <?php echo e($absenceDays); ?>;
            const attendanceRecords = <?php echo e($attendanceDays); ?>;
...
<?php /**PATH C:\xampp\htdocs\FYP-2\SnapChat\resources\views/staff/dashboard.blade.php ENDPATH**/ ?>