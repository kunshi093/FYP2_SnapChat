...
<body class="sb-nav-fixed">
    ...
    <script>
        ...
        document.getElementById('generateQRCodeBtn').addEventListener('click', function () {
            ...
            const qrCodeUrl = '<?php echo e(route("partTime.register")); ?>'; // Part-Time 注册页面的 URL
...
</html><?php /**PATH C:\xampp\htdocs\FYP-2\SnapChat\resources\views/admin/generateQR.blade.php ENDPATH**/ ?>