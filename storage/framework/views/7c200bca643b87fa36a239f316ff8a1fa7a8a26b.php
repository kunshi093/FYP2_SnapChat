...
<head>
    ...
    <title>Part-Time Staff</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css" rel="stylesheet">
    <style>
        body { font-family: Arial, sans-serif; }
        .sb-topnav { position: fixed; width: 100%; top: 0; z-index: 1030; }
        .sb-sidenav { background-color: #343a40; color: #fff; width: 250px; height: 100vh; position: fixed; top: 56px; left: -250px; transition: left 0.3s ease-in-out; }
        ...
        #layoutSidenav_content { margin-left: 0; padding: 20px; margin-top: 70px; transition: margin-left 0.3s ease-in-out; }
    ...
    <div id="layoutSidenav_nav" class="sb-sidenav">
        ...
        <div id="layoutSidenav_content">
            <main class="container mt-4">
                <h2 class="text-center mb-4">Part-Time Staff Records</h2>
...
</html><?php /**PATH C:\xampp\htdocs\FYP-2\SnapChat\resources\views/admin/partTimeStaff.blade.php ENDPATH**/ ?>