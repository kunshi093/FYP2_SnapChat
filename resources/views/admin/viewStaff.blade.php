                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <!-- 修改链接指向个人主页 -->
                                    <a href="{{ route('admin.viewStaffProfile', $staff->id) }}">
                                        {{ $staff->name }}
                                    </a>
                                </td>
                                <td>{{ $staff->email }}</td>
                                <td>
                                    <a href="{{ route('admin.editStaff', $staff->id) }}" class="btn btn-primary btn-sm me-1">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form method="POST" action="{{ route('admin.deleteStaff', $staff->id) }}" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this staff member?');">
                                        @csrf
                                        @method('DELETE')
