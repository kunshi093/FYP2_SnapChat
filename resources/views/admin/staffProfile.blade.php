...
<head>
    ...
    <title>{{ $staff->name }}'s Profile</title>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main class="container mt-4">
                <h1 class="text-center">{{ $staff->name }}'s Profile</h1>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div>
                            @if($staff->photo)
                                <img src="{{ asset('storage/' . $staff->photo) }}" alt="Profile Photo" class="profile-photo mb-3">
                            @else
                ...
                <a href="{{ route('admin.viewStaff') }}" class="btn btn-secondary mt-4">Back to View Staff</a>
            </main>
        </div>
    </div>
